...
function ActiveBidsCountdown({
  ...
  return (
    <div className="flex items-center min-w-[6rem] justify-center text-center  ">
      <p className={`text-sm font-semibold  overflow-x-scroll scrollbar-hide  ${countdown?.hours < 1 && countdown?.minutes < 5 ? "text-red-600" : "text-black"}`}>
...
export default ActiveBidsCountdown;
