...
function HeroCountdown({   serverCountdownInSeconds,
  ...
  return (
    <div className="bottom-0 absolute flex px-2 bg-white py-1 right-0 items-center gap-x-2 rounded-tl-lg">
      <HiOutlineClock className="w-[0.7rem] h-[0.7rem] sm:w-5 sm:h-5" />
      <p className={`text-xs sm:text-lg font-medium ${countdown?.hours < 1 && countdown?.minutes < 5 ? "text-red-600" : "text-black"}`}>
