...
function OngoingBidMobileCountdown({   serverCountdownInSeconds,
  ...
  return (
    <div className="  flex  items-center gap-x-2 ">
      ...
      <p className={`text-[0.625rem] font-semibold ${countdown?.hours < 1 && countdown?.minutes < 5 ? "text-red-600" : "text-black"}`}>
...
export default OngoingBidMobileCountdown;
