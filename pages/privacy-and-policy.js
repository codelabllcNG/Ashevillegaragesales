  ...
  return (
    <div className=" bg-white px-3 sm:px-8 lg:px-[5rem]">
      <Head>
        ...
        <meta
          name="Privacy Policy"
          content="Privacy Policy of Asheville Garage Sales"
        />
      ...
      <p>
        This privacy policy sets out how Asheville Garage Sales uses and
        protects any information that you give Asheville Garage Sales when you
        use our website.
      </p>

      <p>
        Asheville Garage Sales is committed to ensuring that your privacy is
      ...
      <p>
        Asheville Garage Sales may change this policy from time to time by
        updating this page. We may update these Privacy Policy from time to time
        by notifying you of such changes by any reasonable means, including by
        posting a revised Privacy Policy on the Company’s website or by updating
        this page.
      </p>
      ...
      <p>
        ...
        by this privacy policy. You should exercise caution and look at the
      ...
      <ul>
        ...
        <li>
          ...
          writing to or emailing us at contact@ashevillegaragesales.com
        </li>
      </ul>
      ...
      <p>
        ...
        settings, you hereby acknowledge and agree to Asheville Garage Sales use
        of cookies.
      </p>
    </div>
  );
