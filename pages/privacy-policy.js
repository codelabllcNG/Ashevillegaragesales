  ...
  return (
    <div className=" bg-white px-3 sm:px-8 lg:px-[5rem]">
      ...
      <p>
        ...
        posting a revised Privacy Policy on the Company&apos;s website or by
        updating this page.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="mailto:contact@ashevillegaragesales.com">
      ...
      <p>
        ...
        settings, you hereby acknowledge and agree to Asheville Garage
        Sales&apos; use of cookies.
      </p>
    </div>
  );
}
